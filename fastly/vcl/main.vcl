...
sub normalise_querystring_parameters_for_polyfill_bundle {
	...
	if (req.url.qs !~ "(?i)[^&=]*version=([^&]+)") {
		...
		if (re.group.1 == "3.36.0" || re.group.1 == "3.35.0" || re.group.1 == "3.34.0" || re.group.1 == "3.28.1" || re.group.1 == "3.27.4" || re.group.1 == "3.25.3" || re.group.1 == "3.25.2" || re.group.1 == "3.25.1") {
	...
	if (req.url.qs !~ "(?i)[^&=]*ua=([^&]+)") {
		if (req.url.qs ~ "(?i)[^&=]*version=3\.25\.1(&|$)") {
			...
			call normalise_user_agent_1_4_2;
		}
