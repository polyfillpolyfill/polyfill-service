...
var UA = function(uaString) {
	...
	// The longest string that can possibly be a normalized browser name is
	// XXXXXXXXXX/###.###.### (22 chars), so avoid doing the regex if the input
...
UA.prototype.isUnknown = function() {
	return (this.ua.family === 'other' || this.ua.family === 'unknown');
};
