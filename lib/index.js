...
var AliasResolver = require('./aliases');
var UA = require('./UA');
var sourceslib = require('./sources').getCollection();
var path = require('path');
var appVersion = require(path.join(__dirname,'../package.json')).version;
var browserify = require('browserify');
var intoStream = require('into-stream');
var streamToString = require('stream-string');
	...
	return Promise.resolve()
		...
		.then(function(features) {
			...
			.then(function() {
				...
				var commonjsModuleInBundle = false;
				...
				if (commonjsModuleInBundle) {
					var browserifyBundle = browserify(intoStream(builtPolyfillString));
					if (options.minify) {
