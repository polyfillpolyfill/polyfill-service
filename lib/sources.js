...
try {
	...
	console.log('To install historic library versions, run `grunt installcollections` (see docs for the `libVersion` argument for more details)');
};
...
function Collection(version) {
	...
	if (!sources[this.version]) throw('Version not found');
}
