...
module.exports = function getPolyfillParameters(request = {}) {
	...
	const uaString = query.ua || (request.headers && request.headers["user-agent"]) || (typeof request.get === "function" && request.get("User-Agent")) || "";
	...
	return {
		...
		features: featuresfromQueryParameter(features, query.flags),
